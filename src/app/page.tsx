  ...
  return (
    <>
      ...
      <section className="relative flex min-h-[100dvh] flex-col px-5 pt-16 pb-12 sm:px-8 sm:pt-20 lg:pt-24">
        ...
        <div className="relative mx-auto flex w-full max-w-6xl flex-1 flex-row items-center justify-between gap-8">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <pre className="hidden select-none text-[8px] leading-[10px] text-[#ff0000]/40 lg:block lg:text-[11px] lg:leading-[13px]">
{`#**##
                                ********           ****#                                          
                              **********         *******#                                         
                            ***********        **********                                          
